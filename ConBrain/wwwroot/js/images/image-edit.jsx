...
export class ImageEdit extends React.Component {
    ...
    render() {
        ...
        return <div className="fullSize">
            <img scr={this.props.image.id}></img>
            <FormTable action={`/image/edit?id=${this.props.image.id}`} method="POST" name="edit" caption="Edit profile" sendContent="Change" onSend={()=>this.props.onExit()}>
